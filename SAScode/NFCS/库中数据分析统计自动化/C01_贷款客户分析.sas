...
PROC SORT DATA=SSS.Sino_person(WHERE=(SUBSTR(SORGCODE,1,1)='Q' AND SORGCODE^='Q10152900H0000' AND SORGCODE^='Q10152900H0001' AND DATEPART(DGETDATE)<=&STAT_DT.))  OUT=SINO_PERSON ;
	BY spin DGETDATE;
RUN;
DATA SINO_PERSON1;
	SET SINO_PERSON;
...
PROC SORT DATA=SSS.Sino_person(WHERE=(SUBSTR(SORGCODE,1,1)='Q' AND SORGCODE^='Q10152900H0000' AND SORGCODE^='Q10152900H0001' AND DATEPART(DGETDATE)<=&LAST_DT.))  OUT=SINO_PERSON_O ;
	BY spin DGETDATE;
RUN;
DATA SINO_PERSON_01;
	SET SINO_PERSON_O;
